...
const tr: Translations = {
  ...
  services: {
    ...
    list: [
      { title: "Ürün Tedariği", desc: "Bize neye ihtiyacınız olduğunu söyleyin, en iyi Türk üreticileri ve tedarikçileri bulalım. Pazarı araştırır, tedarikçi güvenilirliğini doğrular ve size en iyi seçenekleri sunarız.", icon: "🔍" },
      ...
      { title: "Kalite Kontrol", desc: "Herhangi bir sevkiyat ayrılmadan önce ürünleri spesifikasyonlarınıza ve kalite standartlarınıza uyduğundan emin olmak için inceleriz. Fabrikaları ve depoları şahsen ziyaret ederiz.", icon: "✅" },
