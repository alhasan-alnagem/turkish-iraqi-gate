...
const tr: Translations = {
  ...
  catalogs: {
    ...
    supplier: {
      title: "Üretici veya Tedarikçi misiniz?",
      subtitle: "Ürün kataloğunuzu Irak'taki alıcıların önüne çıkarın. Kataloğunuzu gönderin; web sitemizde listelemek için inceleyelim.",
      button: "Kataloğunuzu Ekleyin",
    },
  },
  contact: {
    hero: {
  ...
  career: {
    hero: {
      ...
      subtitle:
        "Hızla büyüyoruz ve Türkiye-Irak ticareti tutkusu olan, motive insanlar arıyoruz. Gerçek bir fark yaratmaya hazırsanız sizden haber almak isteriz.",
    },
    positions: {
      title: "Açık Pozisyonlar",
      subtitle: "Aşağıdan bir rol seçin ve özgeçmişinizle birlikte başvurunuzu gönderin.",
      type: "Tür",
      location: "Konum",
    ...
    form: {
      title: "Başvuru Yapın",
      subtitle: "Kendinizden bahsedin ve özgeçmişinizi yükleyin. Her başvuruyu bizzat inceliyoruz.",
      name: "Ad Soyad",
      email: "E-posta Adresi",
      phone: "Telefon Numarası (opsiyonel)",
      position: "Pozisyon",
      selectPosition: "Bir pozisyon seçin",
      commissionNote: "Tüm pozisyonlar komisyon esaslıdır.",
      otherOption: "Diğer İş",
      otherPlaceholder: "Örn.: Satış Temsilcisi",
      otherError: "Başvurduğunuz işin adını yazın.",
      cv: "Özgeçmişinizi Yükleyin (PDF)",
      cvHint: "PDF dosyası, en fazla 4 MB",
      message: "Ön Yazı / Mesaj (opsiyonel)",
      ...
      sizeError: "PDF dosyası 4 MB'tan küçük olmalıdır.",
      sending: "Gönderiliyor...",
      placeholders: {
        name: "Örn.: Ayşe Yıldız",
        email: "you@example.com",
        phone: "+90 123 456 789",
        message: "Bu role neden uygun olduğunuzu kısaca anlatın...",
      },
    },
  },
  catalogSubmit: {
    label: "Kataloğunuzu Ekleyin",
    hero: {
      tag: "Üreticiler ve Tedarikçiler İçin",
      title: "Kataloğunuzu Web Sitemize Ekleyin",
      subtitle:
        "Türk üreticilerin ve tedarikçilerin Irak'taki alıcılara ulaşmasına yardımcı oluyoruz. Ürün kataloğunuzu gönderin; ekibimiz web sitemizde listelenmesi için inceleyecektir.",
    },
    how: {
      title: "Nasıl Çalışır",
      steps: [
        "Kataloğunuzu ve şirket bilgilerinizi gönderin.",
        "Ekibimiz ürünlerinizi ve fiyatlarınızı inceler.",
        "Onaylandıktan sonra kataloğunuz listelenir ve Irak'taki alıcılarımıza tanıtılır.",
      ],
    },
    categories: [
      "Tıbbi Ekipman",
    ...
    form: {
      title: "Kataloğunuzu Gönderin",
      subtitle: "Bilgilerinizi doldurun ve kataloğunuzu yükleyin (PDF). Ekibimiz inceleyip size dönüş yapacak.",
      company: "Şirket Adı",
      ...
      catalog: "Kataloğunuzu Yükleyin (PDF)",
      catalogHint: "PDF dosyası, en fazla 4 MB",
      website: "Şirket Web Sitesi (opsiyonel)",
      message: "Ürünler ve Detaylar (opsiyonel)",
      submit: "Kataloğu Gönder",
      required: "* Zorunlu. Her başvuruya yanıt veriyoruz.",
      successTitle: "Katalog Gönderildi!",
      successMessage: "Teşekkürler — size bir onay e-postası gönderdik. Ekibimiz kataloğunuzu inceleyip size dönüş yapacak.",
      sendAnother: "Yeni Bir Katalog Gönder",
      errorMessage: "Bir hata oluştu. Lütfen tekrar deneyin.",
      pdfError: "Lütfen bir PDF dosyası yükleyin.",
      sizeError: "PDF dosyası 4 MB'tan küçük olmalıdır.",
      sending: "Gönderiliyor...",
      placeholders: {
        company: "Örn.: ABC Makine Ltd.",
        contactName: "Örn.: Mehmet Kaya",
        email: "you@company.com",
        phone: "+90 123 456 789",
        website: "www.sirketiniz.com",
        message: "Ana ürünleriniz, minimum sipariş miktarları ve ortalama teslim süreleri hakkında bilgi verin...",
      },
    },
  },
};
