...
const LEGACY_ROUTES = ["about", "services", "products", "catalogs", "submit-catalog", "career", "contact"];
...
export const config = {
  matcher: ["/", "/about", "/services", "/products", "/catalogs", "/submit-catalog", "/career", "/contact"],
};
